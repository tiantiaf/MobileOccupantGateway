							...
							<ul class="nav nav-tabs">
								...
								<li>
									<a href="#survey-manage" data-toggle="tab" id="survey-manage-tab">Manage Surveys</a>
                                                                ...
                                                                <li>
									<a href="#survey-delete" data-toggle="tab" id="survey-delete-tab">Delete Survey</a>
								</li>
								...
								<li>
									<a href="#export-import" data-toggle="tab" id="export-import-tab">Export Survey Data</a>
								</li>
                                                                <li>
									<a href="#export-contextual" data-toggle="tab" id="export-contextual-tab">Export Contexual Data</a>
								</li> 
									...
									<form class="span12 well" method="post" action="add_push_survey.php">
										<div class="row">
											<div class="span4 well">
												...
												<input type="text" class="span12" placeholder="Email_Id" required="" name="q_push_id" id="q_push_id">
									...
									<form class="well span12" method="post" action="add_survey_push_set.php">
										<div class="row">
											...
											<div class="span8">
												...
												<input type="text" class="span8" placeholder="Email ID" required="" name="q_push_set_id" id="q_push_set_id">
											</div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$('#q_type').change(function() {
					if ($(this).val() == 'l' || $(this).val() == 't' || $(this).val() == 'na') {
						$('#q_options').hide();
					} else {
						$('#q_options').show();
					}
