...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Dayday Android Push Demo</title>
    <style type="text/css">
    ...
    <script type="text/javascript">
      $(function() {        
        ...
        $("#button").click(function() {          
          var target = 'dayday/' + $('#messageTarget').val();         		
  ...
  <div id="content">
    ...
    <tr>
      <td>
        <div id="title">Dayday Android Push Demo</div>
      </td>
    </tr>
    <tr>
      <td>
...
?>        
    ...
    <td>
        <div id="buttons">
          ...
          <div class="Back">
          <a href="../index.php">Back to First website</a>
          </div>
